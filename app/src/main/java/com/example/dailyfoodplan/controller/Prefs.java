...
import com.example.dailyfoodplan.model.pref.UpdateReminderPref;
...
public class Prefs {
    ...
    private Prefs(final Context context) {
        this.sharedPrefs = context.getSharedPreferences(com.example.dailyfoodplan.Common.PREFERENCES_FILE, Context.MODE_PRIVATE);
    }
