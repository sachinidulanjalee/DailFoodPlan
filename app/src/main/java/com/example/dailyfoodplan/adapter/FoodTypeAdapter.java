...
public class FoodTypeAdapter extends RecyclerView.Adapter<FoodTypeAdapter.ViewHolder> {
    ...
    private void setBackgroundColor(ViewHolder holder, int position) {
        holder.itemView.setBackgroundColor(com.example.dailyfoodplan.Common.getListItemColorForPosition(holder.itemView.getContext(), position));
    }
            ...
            if (!TextUtils.isEmpty(link)) {
                ...
                textView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        com.example.dailyfoodplan.Common.openUrlInExternalBrowser(textView.getContext(), link);
                    }
                });
            } else {
