...
import com.example.dailyfoodplan.model.DayEntries;
...
public class BackupTask extends TaskWithContext<File, Integer, Boolean> {
    ...
    protected void onPreExecute() {
        ...
        if (DDServings.isEmpty()) {
            com.example.dailyfoodplan.Common.showToast(getContext(), R.string.no_servings_recorded);
    ...
    protected Boolean doInBackground(File... params) {
        ...
        final String lineSeparator = com.example.dailyfoodplan.Common.getLineSeparator();
    ...
    protected void onPostExecute(Boolean success) {
        ...
        //com.example.dailyfoodplan.Common.showToast(context, success ? R.string.backup_success : R.string.backup_failed);
