...
public class TweakBoxes extends LinearLayout {
    ...
    private boolean initTweakIcon() {
        return com.example.dailyfoodplan.Common.loadImage(getContext(), ivIcon, FoodInfo.getTweakIcon(tweak.getName()));
    }
    ...
    public void onTweakNameClicked() {
        com.example.dailyfoodplan.Common.openTweakInfo(getContext(), tweak);
    }

    @OnClick({R.id.tweak_history, R.id.tweak_streak})
    public void onTweakHistoryClicked() {
        com.example.dailyfoodplan.Common.openTweakHistory(getContext(), tweak);
    }
